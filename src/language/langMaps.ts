...
export const langMaps = {
  "navbar": {
    "devPortfolio": "navbar.devPortfolio",
    "home": "navbar.home",
    "about": "navbar.about",
  ...
  "buttons": {
    ...
    "getInTouch": "buttons.getInTouch",
    "contactMe": "buttons.contactMe",
    "downloadCv": "buttons.downloadCv",
    "downloadPdf": "buttons.downloadPdf",
    "viewProject": "buttons.viewProject",
    "viewDetails": "buttons.viewDetails",
    "sendMessage": "buttons.sendMessage",
    "sending": "buttons.sending"
  },
  "header": {
  ...
  "projects": {
    ...
    "splitwallet": {
      "title": "projects.splitwallet.title",
      "description": "projects.splitwallet.description"
    },
    "warehouse": {
      "title": "projects.warehouse.title",
      "description": "projects.warehouse.description"
    },
    "invoice": {
      "title": "projects.invoice.title",
      "description": "projects.invoice.description"
    },
    "more": "projects.more"
  },
  "caseStudy": {
    ...
    "technical": {
      "title": "caseStudy.technical.title",
      "item1": "caseStudy.technical.item1",
      "item2": "caseStudy.technical.item2",
      "item3": "caseStudy.technical.item3",
      "item4": "caseStudy.technical.item4",
      "item5": "caseStudy.technical.item5"
    },
    "features": {
      "title": "caseStudy.features.title",
      "item1": "caseStudy.features.item1",
      "item2": "caseStudy.features.item2",
      "item3": "caseStudy.features.item3",
      "item4": "caseStudy.features.item4",
      "item5": "caseStudy.features.item5"
    }
  },
  "contact": {
    "title": "contact.title",
    ...
    "form": {
      ...
      "sentDescription": "contact.form.sentDescription"
    }
  },
  "footer": {
  ...
  "metadata": {
    ...
    "keywords": {
      "0": "metadata.keywords.0",
      "1": "metadata.keywords.1",
      "2": "metadata.keywords.2",
      "3": "metadata.keywords.3",
      "4": "metadata.keywords.4",
      "5": "metadata.keywords.5",
      "6": "metadata.keywords.6"
    }
  },
  "cv": {
  ...
  "profile": {
    "personalInfo": {
      ...
      "links": {
        "0": {
          "label": "profile.personalInfo.links.0.label",
          "url": "profile.personalInfo.links.0.url"
        },
        "1": {
          "label": "profile.personalInfo.links.1.label",
          "url": "profile.personalInfo.links.1.url"
        },
        "2": {
          "label": "profile.personalInfo.links.2.label",
          "url": "profile.personalInfo.links.2.url"
        }
      },
      "contactDetails": {
        "0": {
    ...
    "experiences": {
      ...
      "1": {
        "company": "profile.experiences.1.company",
      ...
      "2": {
        "company": "profile.experiences.2.company",
      ...
      "4": {
        ...
        "position": "profile.experiences.4.position",
        "period": "profile.experiences.4.period",
        "location": "profile.experiences.4.location",
    ...
    "skillCategories": {
      "0": {
        "name": "profile.skillCategories.0.name",
        "items": {
          "0": "profile.skillCategories.0.items.0",
          "1": "profile.skillCategories.0.items.1",
          "2": "profile.skillCategories.0.items.2",
          "3": "profile.skillCategories.0.items.3",
          "4": "profile.skillCategories.0.items.4",
          "5": "profile.skillCategories.0.items.5",
          "6": "profile.skillCategories.0.items.6",
          "7": "profile.skillCategories.0.items.7"
        }
      },
      "1": {
        "name": "profile.skillCategories.1.name",
        "items": {
          "0": "profile.skillCategories.1.items.0",
          "1": "profile.skillCategories.1.items.1",
          "2": "profile.skillCategories.1.items.2",
          "3": "profile.skillCategories.1.items.3",
          "4": "profile.skillCategories.1.items.4",
          "5": "profile.skillCategories.1.items.5",
          "6": "profile.skillCategories.1.items.6",
          "7": "profile.skillCategories.1.items.7"
        }
      },
      "2": {
        "name": "profile.skillCategories.2.name",
        "items": {
          "0": "profile.skillCategories.2.items.0",
          "1": "profile.skillCategories.2.items.1",
      ...
      "3": {
        "name": "profile.skillCategories.3.name",
        "items": {
          "0": "profile.skillCategories.3.items.0",
          "1": "profile.skillCategories.3.items.1",
          "2": "profile.skillCategories.3.items.2",
          "3": "profile.skillCategories.3.items.3",
    ...
    "projectSummaries": {
      "0": {
        "title": "profile.projectSummaries.0.title",
        "description": "profile.projectSummaries.0.description",
        "link": "profile.projectSummaries.0.link",
        "technologies": {
          "0": "profile.projectSummaries.0.technologies.0",
          "1": "profile.projectSummaries.0.technologies.1",
          "2": "profile.projectSummaries.0.technologies.2",
